...
("What would convince me" = your **acceptance criteria**, set *before* delegating: the highest-leverage habit here.)
...
verify), scope ("smallest thing"), reporting — copy-pasteable, say so. "If
you don't know what would convince you, you're not ready to delegate" —
figuring that out IS the research thinking. Land the closing hard: "I didn't
type it, but I understand it and can defend it" is the whole talk in a line.
:::
