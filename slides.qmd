...
4. *"Is there a **tool or account** the lab already uses or can give me
   access to?"*
5. *"By the end of the summer, **which parts of this project should I be
...
practical: lab/university accounts beat free tiers, and some labs have an
approved-tools list. Question 5 is the one mentors will love them for
asking — it defines the learning goals up front and previews Part 6 (the
delegation boundary: you can only delegate what you could evaluate). The
data question previews the Ground rules slide near the end.
:::
