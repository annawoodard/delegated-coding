...
## First, the rule that outranks this talk {.center}

⚠️ **Talk to your mentor.**

Every lab has its own expectations about AI use —
for the code, the data, the writing.

Have that conversation in **week 1**, not week 9.
...
::: {.notes}
~1 min. Deliver plainly — norms genuinely differ across labs, and students
can't yet tell which norms are universal vs. lab-specific. This comes back
on the Ground rules slide near the end.
:::
