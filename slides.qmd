...
that out *is* the research. (And if the check is runnable, the agent can iterate on it itself — Part 4.)
...
5 (give it a checkable target): a runnable acceptance criterion IS the
