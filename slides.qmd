...
- Fine for a throwaway script or a weekend project
- Not fine when someone — you, your mentor, eventually a reviewer — has to **trust the result**
...
⚠️ **Before any of this: talk to your mentor.** Every lab has its own
expectations about AI use — for the code, the data, the writing.
Have that conversation in **week 1**, not week 9. Nothing in this talk
overrides what your mentor tells you.

::: {.notes}
~4 min. Most of them have vibe-coded already — don't pretend otherwise.
The pitch: research raises the stakes. Vibes don't survive a methods
section. "Managing your AI collaborators" is meant literally: by August
you'll supervise more code than you write. Deliver the mentor caveat
plainly and early — norms genuinely differ across labs, and students
can't yet tell which norms are universal vs. lab-specific. It comes back
on the Ground rules slide near the end. Today: (1) what these tools
