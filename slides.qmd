...
- stage 2 rewards what **readers like**: confident, agreeable, rarely *"I don't know"*

. . .

Fluent and confident **by construction**, including when it's wrong:
...
that lands: the model was trained to make the reader happy, not to be
right; when those conflict you get confident nonsense and yes-and
agreement (sycophancy). So confidence is part of the output style, not
evidence of correctness. Everything in Part 5 traces back to this slide.
:::
