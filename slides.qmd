...
slide. Rough timing (~58-60 min — fits the hour if Q&A can spill a little;
the remaining lever is cutting "three generations", ~-2 min):
  ~5   hook + reframe
  ~11  part 1: what you're working with (LLMs, agents, harnesses)
  ~4   part 2: research is a different game
  ~9   part 3: the mental model
  ~16  part 4: running the lab (now 7 practices: added "give it a checkable target")
...
⚠️ **Talk to your mentor — in week 1, not week 9.** Three questions to ask:
...
turns up in week 8, the mentor asks "what if we exclude those samples?"
Reproducibility isn't an ideal here, it's self-defense —
week-9-you rerunning everything after a bug fix is a near certainty; it
